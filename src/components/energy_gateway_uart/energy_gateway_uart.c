...
#define ECHO_TEST_TXD (CONFIG_UART_TXD)
#define ECHO_TEST_RXD (CONFIG_UART_RXD)
#define ECHO_TEST_RTS (UART_PIN_NO_CHANGE)
#define ECHO_TEST_CTS (UART_PIN_NO_CHANGE)

#define ECHO_UART_PORT_NUM      (CONFIG_UART_PORT_NUM)
#define ECHO_UART_BAUD_RATE     (CONFIG_UART_BAUD_RATE)
#define ECHO_TASK_STACK_SIZE    (CONFIG_TASK_STACK_SIZE)
